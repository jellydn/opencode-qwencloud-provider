...
Prompt for the video: $ARGUMENTS

Note: video generation is async and may take a few minutes. After generation completes, report the saved file path to the user.
